...
#Create a data stream plot with no inputs
...
#ax.text(0.5, 0.8, "No Input", ha="center", va="center", color="black", fontsize=18, style='italic')


arrow = plt.Arrow(1.05, 0.5, 0.1, 0, width=0.02, color="black")
ax.add_patch(arrow)

#ax.text(1.15, 0.5, "(., Output)", ha="left", va="center", color="black", fontsize=12)
