...
#Create a data stream plot with 2 outputs
...
ax.text(2/6, 0.45, "$Output_{1}$", ha="center", va="center", color="black", fontsize=20)
ax.text(5/6, 0.45, "$Output_{2}$", ha="center", va="center", color="black", fontsize=20)


path_data = [
    (Path.MOVETO, [5/6 , 0.425]),
    (Path.CURVE3, [3.5/6 , 0.35]),
    (Path.CURVE3, [2/6, 0.425]),
]
...
path_data = [
    (Path.MOVETO, [3.5/6 , 0.37]),
    (Path.CURVE3, [2.25/6 , 0.3]),
...
#ax.text(0.5, 0.8, "Several Outputs", ha="center", va="center", color="black", fontsize=18, style='italic')

arrow = plt.Arrow(1.05, 0.5, 0.1, 0, width=0.02, color="black")
ax.add_patch(arrow)

#ax.text(1.15, 0.5, "(Input, ($Output_{1}$,$Output_{2}$))", ha="left", va="center", color="black", fontsize=12)
